  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-4 flex-wrap">
        <div className="w-full sm:w-[35vw] h-auto flex items-center justify-center overflow-hidden">
          <img
            src={zomato}
            alt="Zomato Logo"
        ...
        <div className="w-full sm:w-[39vw] h-auto   flex items-center justify-center overflow-hidden">
          <img
            src={swiggy}
            alt="Swiggy Logo"
            className="w-full h-full object-contain"
